...
# ---------------------------- Example Usage for Prompts ----------------------------
def respond_to_prompt(model, prompt, english_to_index, simplified_to_index, index_to_simplified, device):
    """
    Takes a prompt (English sentence) and returns the model's simplified response.
    """
    simplified_output = translate_sentence(model, prompt, english_to_index, simplified_to_index, index_to_simplified, device)
...
for prompt in prompts:
    response = respond_to_prompt(model, prompt, english_to_index, simplified_to_index, index_to_simplified, device)
