...
if __name__ == "__main__":
    train_data_three_input = [
        ("What is the weather like in Long Beach?", "And in Los Angeles?", "How about San Diego?", "It's sunny in Long Beach, partly cloudy in LA, and clear in San Diego."),
        ("Tell me a joke.", "Tell me another one.", "And a short one?", "Why don't scientists trust atoms? Because they make up everything! What do you call a fake noodle? An impasta! Parallel lines have so much in common... it's a shame they'll never meet."),
        ("What is your favorite color?", "Why?", "Do you like blue?", "As an AI, I don't have personal preferences like favorite colors, but blue is often associated with calmness and intelligence."),
        ("How old are you?", "When were you created?", "Who created you?", "I am a large language model, trained by Google."),
        ("Sing me a song.", "A sad one.", "Just a few lines.", "I'm sorry, but I don't have the ability to sing.")
    ]

    ai_model_three_input = SimpleTextToTextAI(train_data_three_input, num_epochs=10)
    ai_model_three_input.train()

    prompt1 = "What time is it here in Long Beach?"
    prompt2 = "And what's the date today?"
    prompt3 = "Can you also tell me the day of the week?"

    response = ai_model_three_input.respond_to_three_inputs(prompt1, prompt2, prompt3)
    print("\n---------------------------- Example Response to Three Inputs ----------------------------")
    print(f"Prompt 1: {prompt1}")
    print(f"Prompt 2: {prompt2}")
    print(f"Prompt 3: {prompt3}")
    print(f"Response: {response}")

    # You can try with other sets of three related prompts based on your training data
    prompt_a = "Tell me something interesting."
    prompt_b = "Something related to space."
    prompt_c = "Make it brief."
    response_abc = ai_model_three_input.respond_to_three_inputs(prompt_a, prompt_b, prompt_c)
    print("\n---------------------------- Another Example ----------------------------")
    print(f"Prompt A: {prompt_a}")
    print(f"Prompt B: {prompt_b}")
    print(f"Prompt C: {prompt_c}")
    print(f"Response: {response_abc}")
